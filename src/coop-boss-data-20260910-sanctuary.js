...
const BOSSES = Object.freeze({
  "coast-tide-core-cave": regional({
    id: "coast-core-shark",
    mapId: "coast-tide-core-cave",
    name: "심해 코어 포식자",
    enemyKind: "pirate-shark",
    x: 1600,
    y: 1280,
    baseHp: 300,
    rewardExp: 150,
  ...
  "sanctuary-core-heart": Object.freeze({
    ...
    name: "ORIGIN-0 — 최초의 수호자",
    enemyKind: "core-sentinel",
    x: 1080,
    y: 760,
    baseHp: 1200,
    rewardExp: 0,
