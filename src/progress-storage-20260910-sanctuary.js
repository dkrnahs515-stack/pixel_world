import { REWARD_POTION_LIMIT, normalizeRedeemedCodeIds } from "./reward-codes-20260905-upgrade.js";
import {
  ADVENTURE_QUEST,
...
import {
  grantProgressReward,
  nextLevelExp,
} from "./player-progression-20260905-upgrade.js";
import {
...
import { normalizeWorldProgress } from "./chapter-progress-20260910-sanctuary.js";
...
function isValidEndingTitle(value) {
  return value === undefined || value === null || ENDING_TITLES.has(value);
}

function normalizeEndingTitle(value) {
...
function toBaseAndInventoryProgress(value, { introSeenDefault = false } = {}) {
  return {
    ...
    endingTitle: normalizeEndingTitle(value.endingTitle),
