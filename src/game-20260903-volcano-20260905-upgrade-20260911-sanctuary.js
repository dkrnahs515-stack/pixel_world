import { questNotifications } from "./quest-notifications-20260905-upgrade-20260911-sanctuary.js";
import { storyGuidance } from "./quest-guidance-20260905-upgrade-20260911-sanctuary.js";
import { QuestBanner, drawQuestGuidance } from "./quest-banner-20260905-upgrade-20260911-sanctuary.js";
import { rewardCodeEffects } from "./reward-codes-20260905-upgrade-20260911-sanctuary.js";
import { applyRewardModifiers, drawSlimeBody, drawPencilWeapon } from "./reward-cosmetics-20260905-upgrade-20260911-sanctuary.js";
import { createTripleBossController } from "./triple-boss-controller-20260905-upgrade-20260911-sanctuary.js";
import { finalizeSkillResource, tickManaRegen, skillAvailability, createSkillCast, advanceSkillCast } from "./skill-runtime-20260905-upgrade-20260911-sanctuary.js";
import { GAME_CONFIG as C } from "./config-20260905-upgrade-20260911-sanctuary.js";
import { DEFAULT_CLASS_ID, getClassDefinition, normalizeClassId } from "./class-data-20260905-upgrade-20260911-sanctuary.js";
import { drawClassEquipment } from "./class-rendering-20260905-upgrade-20260911-sanctuary.js";
import { layoutChatBubble, worldToScreen } from "./chat-bubble-layout-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { ChatController } from "./chat-controller-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { latestBubblesByUid } from "./chat-state-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { attackDefinition, directionVector, isTargetInAttackArc } from "./combat-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { advanceHitEffects, createHitEffect, drawHitEffects, hitShakeOffset } from "./combat-effects-20260905-upgrade-20260911-sanctuary.js";
...
import {
  ...
  drawEnemy,
  updateEnemies,
} from "./enemies-20260829-coast-20260905-upgrade-20260911-sanctuary.js";
import { getEnemyDefinition } from "./enemy-definitions-20260905-upgrade-20260911-sanctuary.js";
import { movementVector } from "./input-20260905-upgrade-20260911-sanctuary.js";
...
} from "./story-interactions-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { getNpcsForWorld } from "./npc-data-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { drawNpc, findNearbyNpc } from "./npcs-20260905-upgrade-20260911-sanctuary.js";
import {
  applyPlayerDamage,
  applyPlayerSlow,
  ...
  respawnPlayer,
  tickPlayerStatus,
} from "./player-combat-20260905-upgrade-20260911-sanctuary.js";
import { advancePortalTransition, canUsePortal, createPortalTransition } from "./portal-transition-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { grantCoopBossReward, grantHuntingReward, statsForLevel } from "./player-progression-20260905-upgrade-20260911-sanctuary.js";
import { getCoopBossById, getCoopBossForMap } from "./coop-boss-data-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  createProjectile,
  updateProjectiles as simulateProjectiles,
} from "./projectile-combat-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { drawExplosionEffect, drawProjectile } from "./projectile-rendering-20260905-upgrade-20260911-sanctuary.js";
import { loadProgressWithStatus, saveProgress } from "./progress-storage-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  createPerformanceMetrics,
  isPerformanceTrackingGap,
  recordPerformanceFrame,
  trackedFpsFromFrameSeconds,
} from "./performance-metrics-20260905-upgrade-20260911-sanctuary.js";
import {
  findQaBossApproachPosition,
  findQaSpawnPosition,
  getQaMonster,
  prepareWeaponQaProgress,
} from "./qa-mode-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { SHOP_ITEMS, buyShopItem, usePotion } from "./shop-state-20260905-upgrade-20260911-sanctuary.js";
import {
  buyWeapon,
  equipWeapon,
  getClassEquipment,
...
} from "./equipment-ui-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  STARTER_WEAPON_ID,
  getWeaponDefinition,
  resolveWeaponDefinition,
} from "./weapon-data-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  drawScabbard,
  drawWeapon,
} from "./weapon-rendering-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  ADVENTURE_QUEST,
  ...
  recordAdventureKill,
} from "./quest-state-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import { arenDialogueModel } from "./aren-dialogue-20260829-coast-20260905-upgrade-20260911-sanctuary.js";
import { getWorldDefinition, normalizeWorldId } from "./world-data-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  createWorldLayer,
  ...
  prewarmWorldLayers,
} from "./world-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
import {
  advanceVolcanoEruption,
  createVolcanoEruptionState,
  drawVolcanoEruption,
} from "./volcano-eruption-20260903-volcano-20260905-upgrade-20260911-sanctuary.js";
...
export class PixelRPG {
  constructor(elements) {
    ...
    this.endingActionInFlight = false;
  ...
  async recoverSanctuaryEndingReward() {
    if (this.endingActionInFlight) return false;
  ...
  handleSanctuaryEndingKeyDown(event) {
    ...
    const focusedControl = this.activeSanctuaryEndingFocusControls().includes(focused) ? focused : null;
    if (focusedControl && typeof focusedControl.click === "function") {
      event.preventDefault?.();
      event.stopPropagation?.();
      focusedControl.click();
      return true;
    }
    if (focused && (focused === this.ui.endingOverlay || this.ui.endingOverlay.contains?.(focused))) return false;
    event.preventDefault?.();
    event.stopPropagation?.();
    if (view === "first-confirmation") {
      return this.previewSanctuaryEnding(this.ui.endingChoiceButtons?.[0]?.dataset?.endingChoice);
    }
    if (view === "second-confirmation") {
      void this.confirmSanctuaryEnding(this.pendingSanctuaryEndingChoice);
      return true;
    }
    if (this.pendingSanctuaryRewardChoice) {
      void this.recoverSanctuaryEndingReward();
      return true;
    }
